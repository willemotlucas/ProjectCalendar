...
protected :
    ...
    /*!
         ...
         */
      TacheUnitaire(const QString& id, const QString& desc, const QDate& dispo, const QDate& deadline, const QTime& dur, const int& e = 1):Tache(id, desc, dispo, deadline,e){if(duree < QTime(DUREE_MAX,0)) duree = dur; else throw CalendarException("La durée d'une tâche unitaire ne peut être supérieur à 12h."); }
...
public:
    ...
    virtual void setEtat(const int& e) { etat = (Etat)e; }
    virtual const int& getEtat() const { return (int)etat; }
