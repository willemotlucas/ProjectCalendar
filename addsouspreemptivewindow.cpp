...
AddSousPreemptiveWindow::AddSousPreemptiveWindow(QWidget* parent):QDialog(parent){
    this->setWindowTitle("Nouvelle Sous-Tache Preemptive");
    ...
    connect(ok,SIGNAL(clicked()),this,SLOT(envoiSousTachePreemtive()));
    connect(annuler,SIGNAL(clicked()),this,SLOT(close()));
}


void AddSousPreemptiveWindow::envoiSousTachePreemtive(){
    try{
